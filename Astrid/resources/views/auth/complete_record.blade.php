    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" style="color:white; border-color:black; background:black;">Completar Registro</div>
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/complete/'.$id) }}">
                        ...
                        <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}"> 
                            <label for="password" class="col-md-4 control-label">Nombre</label>
